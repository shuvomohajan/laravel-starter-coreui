...
/***/ "./resources/js/dashboard/coreui.bundle.min.js":
/*!*****************************************************!*\
  !*** ./resources/js/dashboard/coreui.bundle.min.js ***!
  \*****************************************************/
...
!function (t, e) {
  ...
  var t = {
    ...
    next: function next(t, e) {
      ...
      e = "transitionend",
      i = function i(t) {
    var e = t.getAttribute("data-coreui-target");
    ...
    Object.keys(i).forEach(function (n) {
      var s = i[n],
          o = e[n],
          a = o && r(o) ? "element" : null == (l = o) ? "".concat(l) : {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase();
      var l;
    ...
    i.addEventListener(e, a), setTimeout(function () {
      r || o(i);
    }, s);
  },
  ...
  var j = {
    ...
    off: function off(t, e, i, n) {
      ...
      c && Object.keys(l).forEach(function (i) {
        !function (t, e, i, n) {
          ...
          Object.keys(s).forEach(function (o) {
            if (o.includes(n)) {
              var _n3 = s[o];
              $(t, e, i, _n3.originalHandler, _n3.delegationSelector);
            }
          });
        }(t, l, i, e.slice(1));
      });
      ...
      Object.keys(h).forEach(function (i) {
        ...
        if (!a || e.includes(n)) {
          var _e3 = h[i];
          $(t, l, r, _e3.originalHandler, _e3.delegationSelector);
        }
      });
    },
  ...
  var B = /*#__PURE__*/function () {
    ...
    _createClass(B, [{
      ...
      key: "DATA_KEY",
      get: function get() {
        return "coreui.".concat(this.NAME);
      }
    }, {
      key: "EVENT_KEY",
      get: function get() {
  ...
  var W = '[data-coreui-toggle="button"]';
  ...
  j.on(document, "click.coreui.button.data-api", W, function (t) {
    t.preventDefault();
  ...
  var V = {
    setDataAttribute: function setDataAttribute(t, e, i) {
      t.setAttribute("data-coreui-".concat(z(e)), i);
    },
    removeDataAttribute: function removeDataAttribute(t, e) {
      t.removeAttribute("data-coreui-".concat(z(e)));
    },
    getDataAttributes: function getDataAttributes(t) {
      if (!t) return {};
      var e = {};
      return Object.keys(t.dataset).filter(function (t) {
        return t.startsWith("coreui");
      }).forEach(function (i) {
        var n = i.replace(/^coreui/, "");
        n = n.charAt(0).toLowerCase() + n.slice(1, n.length), e[n] = U(t.dataset[i]);
      }), e;
    },
    getDataAttribute: function getDataAttribute(t, e) {
      return U(t.getAttribute("data-coreui-".concat(z(e))));
    },
    ...
    ArrowRight: Z
      ...
      it = "slid".concat(K),
      nt = "keydown".concat(K),
      st = "mouseenter".concat(K),
      ot = "mouseleave".concat(K),
      rt = "touchstart".concat(K),
      at = "touchmove".concat(K),
      lt = "touchend".concat(K),
      ct = "pointerdown".concat(K),
      ht = "pointerup".concat(K),
      dt = "dragstart".concat(K),
      ut = "load".concat(K, ".data-api"),
      ft = "click".concat(K, ".data-api"),
      pt = "active",
      gt = ".active.carousel-item",
      mt = "touch";

  var _t = /*#__PURE__*/function (_B3) {
    _inherits(_t, _B3);

    var _super3 = _createSuper(_t);
    ...
    _createClass(_t, [{
      ...
      value: function to(e) {
        ...
        if (this._isSliding) return void j.one(this._element, it, function () {
          return _this4.to(e);
        });
      ...
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, Y), V.getDataAttributes(this._element)), "object" == _typeof(t) ? t : {}), l(F, t, Q), t;
      }
    }, {
      key: "_handleSwipe",
      ...
      value: function _addEventListeners() {
        ...
        this._config.keyboard && j.on(this._element, nt, function (t) {
          return _this5._keydown(t);
        }), "hover" === this._config.pause && (j.on(this._element, st, function (t) {
          return _this5.pause(t);
        }), j.on(this._element, ot, function (t) {
      ...
      value: function _addTouchEventListeners() {
        ...
        var e = function e(t) {
          !_this6._pointerEvent || "pen" !== t.pointerType && t.pointerType !== mt ? _this6._pointerEvent || (_this6.touchStartX = t.touches[0].clientX) : _this6.touchStartX = t.clientX;
        },
            i = function i(t) {
          _this6.touchDeltaX = t.touches && t.touches.length > 1 ? 0 : t.touches[0].clientX - _this6.touchStartX;
        },
            n = function n(t) {
          !_this6._pointerEvent || "pen" !== t.pointerType && t.pointerType !== mt || (_this6.touchDeltaX = t.clientX - _this6.touchStartX), _this6._handleSwipe(), "hover" === _this6._config.pause && (_this6.pause(), _this6.touchTimeout && clearTimeout(_this6.touchTimeout), _this6.touchTimeout = setTimeout(function (t) {
            return _this6.cycle(t);
          }, 500 + _this6._config.interval));
        };

        t.find(".carousel-item img", this._element).forEach(function (t) {
          j.on(t, dt, function (t) {
            return t.preventDefault();
          });
        }), this._pointerEvent ? (j.on(this._element, ct, function (t) {
          return e(t);
        }), j.on(this._element, ht, function (t) {
          return n(t);
        }), this._element.classList.add("pointer-event")) : (j.on(this._element, rt, function (t) {
          return e(t);
        }), j.on(this._element, at, function (t) {
          return i(t);
        }), j.on(this._element, lt, function (t) {
          return n(t);
        }));
      }
    }, {
      ...
      value: function _setActiveIndicatorElement(e) {
        if (this._indicatorsElement) {
          ...
          _i4.classList.remove(pt), _i4.removeAttribute("aria-current");

          var _n4 = t.find("[data-coreui-target]", this._indicatorsElement);

          for (var _t3 = 0; _t3 < _n4.length; _t3++) {
            if (Number.parseInt(_n4[_t3].getAttribute("data-coreui-slide-to"), 10) === this._getItemIndex(e)) {
              _n4[_t3].classList.add(pt), _n4[_t3].setAttribute("aria-current", "true");
              break;
            }
          }
        }
      ...
      value: function _updateInterval() {
        var e = this._activeElement || t.findOne(gt, this._element);
        if (!e) return;
        var i = Number.parseInt(e.getAttribute("data-coreui-interval"), 10);
      ...
      value: function _slide(e, i) {
        ...
        if (this._element.classList.contains("slide")) {
          ...
          var _t4 = function _t4() {
            r.classList.remove(h, d), r.classList.add(pt), s.classList.remove(pt, d, h), _this7._isSliding = !1, setTimeout(p, 0);
          };
      ...
      value: function carouselInterface(t, e) {
        var i = _t.getOrCreateInstance(t, e);
      ...
      value: function dataApiClickHandler(t) {
        ...
        var i = _objectSpread(_objectSpread({}, V.getDataAttributes(e)), V.getDataAttributes(this)),
  ...
  j.on(document, ft, "[data-coreui-slide], [data-coreui-slide-to]", _t.dataApiClickHandler), j.on(window, ut, function () {
    var e = t.find('[data-coreui-ride="carousel"]');

    for (var _t5 = 0, _i5 = e.length; _t5 < _i5; _t5++) {
      _t.carouselInterface(e[_t5], _t.getInstance(e[_t5]));
    }
  }), _(_t);
  var vt = "collapse",
      bt = "coreui.collapse",
  ...
  var $t = /*#__PURE__*/function (_B4) {
    ...
    function $t(e, i) {
      ...
      _this8 = _super4.call(this, e), _this8._isTransitioning = !1, _this8._config = _this8._getConfig(i), _this8._triggerArray = t.find("".concat(It, "[href=\"#").concat(_this8._element.id, "\"],").concat(It, "[data-coreui-target=\"#").concat(_this8._element.id, "\"]"));
      var s = t.find(It);
    ...
    _createClass($t, [{
      ...
      value: function show() {
        ...
        this._parent && (e = t.find(".show, .collapsing", this._parent).filter(function (t) {
          return "string" == typeof _this9._config.parent ? t.getAttribute("data-coreui-parent") === _this9._config.parent : t.classList.contains(xt);
        }), 0 === e.length && (e = null));
        ...
        if (e) {
          ...
          if (i = _t6 ? $t.getInstance(_t6) : null, i && i._isTransitioning) return;
        }
        ...
        this._element.classList.remove(xt), this._element.classList.add(Dt), this._element.style[s] = 0, this._triggerArray.length && this._triggerArray.forEach(function (t) {
          t.classList.remove(Nt), t.setAttribute("aria-expanded", !0);
        }), this.setTransitioning(!0);
        var o = "scroll".concat(s[0].toUpperCase() + s.slice(1));
        this._queueCallback(function () {
          _this9._element.classList.remove(Dt), _this9._element.classList.add(xt, kt), _this9._element.style[s] = "", _this9.setTransitioning(!1), j.trigger(_this9._element, Tt);
        }, this._element, !0), this._element.style[s] = "".concat(this._element[o], "px");
      }
    }, {
      key: "hide",
      value: function hide() {
        ...
        this._element.style[t] = "".concat(this._element.getBoundingClientRect()[t], "px"), f(this._element), this._element.classList.add(Dt), this._element.classList.remove(xt, kt);
        var e = this._triggerArray.length;
        if (e > 0) for (var _t7 = 0; _t7 < e; _t7++) {
          var _e5 = this._triggerArray[_t7],
              _i8 = s(_e5);

          _i8 && !_i8.classList.contains(kt) && (_e5.classList.add(Nt), _e5.setAttribute("aria-expanded", !1));
        }
        this.setTransitioning(!0);
        this._element.style[t] = "", this._queueCallback(function () {
          _this10.setTransitioning(!1), _this10._element.classList.remove(Dt), _this10._element.classList.add(xt), j.trigger(_this10._element, Ot);
        }, this._element, !0);
      }
    }, {
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return (t = _objectSpread(_objectSpread({}, wt), t)).toggle = Boolean(t.toggle), l(vt, t, Et), t;
      }
    }, {
      key: "_getDimension",
      ...
      value: function _getParent() {
        ...
        e = a(e);
        var i = "".concat(It, "[data-coreui-parent=\"").concat(e, "\"]");
      ...
      value: function collapseInterface(t, e) {
        var i = $t.getInstance(t);

        var n = _objectSpread(_objectSpread(_objectSpread({}, wt), V.getDataAttributes(t)), "object" == _typeof(e) && e ? e : {});
  ...
  function we(t) {
    for (var e = re(t), i = ye(t); i && _e(i) && "static" === me(i).position;) {
      i = ye(i);
    }
  ...
  var xe = {
    ...
    fn: function fn(t) {
      ...
      if (o && r) {
        var h = function (t, e) {
          return Ce("number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, {
  ...
  function Ke(t, e, i) {
    var n = "clippingParents" === e ? function (t) {
      var e = ze(be(t)),
          i = ["absolute", "fixed"].indexOf(me(t).position) >= 0 && le(t) ? we(t) : t;
        ...
        return t[i] = function (t, e, i) {
          var n = de(t),
            ...
            placement: t
              ...
              r = o[0],
              a = o[1];
          return r = r || 0, a = (a || 0) * s, [Ht, Pt].indexOf(n) >= 0 ? {
            x: a,
            y: r
          } : {
            x: r,
  ...
  var ci = li(),
      hi = li({
    defaultModifiers: [Me, ii, Ie, he]
  }),
      di = li({
    defaultModifiers: [Me, ii, Ie, he, ei, Ge, ni, xe, ti]
  }),
      ui = Object.freeze({
    __proto__: null,
    popperGenerator: li,
  ...
  var fi = "dropdown",
      ...
      Ai = "shown".concat(pi),
      Ti = "click".concat(pi),
      Li = "click".concat(pi, ".data-api"),
      Oi = "keydown".concat(pi, ".data-api"),
      Ci = "keyup".concat(pi, ".data-api"),
      ki = "show",
  ...
  var Bi = /*#__PURE__*/function (_B5) {
    _inherits(Bi, _B5);

    var _super5 = _createSuper(Bi);
    ...
    _createClass(Bi, [{
      ...
      value: function show() {
        ...
        var t = Bi.getParentFromElement(this._element),
            e = {
        ...
        if (!j.trigger(this._element, Ei, e).defaultPrevented) {
          ...
          if (this._inNavbar) V.setDataAttribute(this._menu, "popper", "none");else {
            ...
            this._popper = di(_e6, this._menu, _i9), _n5 && V.setDataAttribute(this._menu, "popper", "static");
          }
          "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && (_ref4 = []).concat.apply(_ref4, _toConsumableArray(document.body.children)).forEach(function (t) {
            return j.on(t, "mouseover", u);
          }), this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.toggle(ki), this._element.classList.toggle(ki), j.trigger(this._element, Ai, e);
        }
      }
    }, {
      key: "hide",
      ...
      key: "dispose",
      value: function dispose() {
        this._popper && this._popper.destroy(), _get(_getPrototypeOf(Bi.prototype), "dispose", this).call(this);
      }
    }, {
      key: "update",
      ...
      value: function _addEventListeners() {
        ...
        j.on(this._element, Ti, function (t) {
      ...
      value: function _completeHide(t) {
        ...
        j.trigger(this._element, yi, t).defaultPrevented || ("ontouchstart" in document.documentElement && (_ref5 = []).concat.apply(_ref5, _toConsumableArray(document.body.children)).forEach(function (t) {
          return j.off(t, "mouseover", u);
        }), this._popper && this._popper.destroy(), this._menu.classList.remove(ki), this._element.classList.remove(ki), this._element.setAttribute("aria-expanded", "false"), V.removeDataAttribute(this._menu, "popper"), j.trigger(this._element, wi, t));
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
        if (t = _objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), V.getDataAttributes(this._element)), t), l(fi, t, this.constructor.DefaultType), "object" == _typeof(t.reference) && !r(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("".concat(fi.toUpperCase(), ": Option \"reference\" provided type \"object\" without a required \"getBoundingClientRect\" method."));
        return t;
      }
    }, {
      key: "_getMenuElement",
      ...
      value: function _getPlacement() {
        ...
        var e = "end" === getComputedStyle(this._menu).getPropertyValue("--cui-position").trim();
      ...
      value: function dropdownInterface(t, e) {
        var i = Bi.getOrCreateInstance(t, e);
      ...
      value: function clearMenus(e) {
        ...
        for (var _t8 = 0, _n6 = i.length; _t8 < _n6; _t8++) {
          var _n7 = Bi.getInstance(i[_t8]);

          if (!_n7 || !1 === _n7._config.autoClose) continue;
          if (!_n7._element.classList.contains(ki)) continue;
          var _s3 = {
      ...
      value: function dataApiKeydownHandler(e) {
        ...
        var i = this.classList.contains(ki);
        if (!i && e.key === gi) return;
        if (e.preventDefault(), e.stopPropagation(), h(this)) return;

        var n = function n() {
          return _this15.matches(xi) ? _this15 : t.prev(_this15, xi)[0];
        };
  ...
  var Ri = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
      Wi = ".sticky-top";
    ...
    _createClass(qi, [{
      ...
      value: function hide() {
        ...
        this._disableOverFlow(), this._setElementAttributes(this._element, "paddingRight", function (e) {
          return e + t;
        }), this._setElementAttributes(Ri, "paddingRight", function (e) {
          return e + t;
        }), this._setElementAttributes(Wi, "marginRight", function (e) {
          return e - t;
        });
      }
    }, {
  ...
  var Yi = /*#__PURE__*/function () {
    ...
    _createClass(Yi, [{
      ...
      value: function show(t) {
        this._config.isVisible ? (this._append(), this._config.isAnimated && f(this._getElement()), this._getElement().classList.add(Fi), this._emulateAnimation(function () {
          v(t);
        })) : v(t);
      }
    }, {
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return (t = _objectSpread(_objectSpread({}, Ui), "object" == _typeof(t) ? t : {})).rootElement = a(t.rootElement), l(Vi, t, zi), t;
      }
    }, {
      key: "_append",
      value: function _append() {
        ...
        this._isAppended || (this._config.rootElement.appendChild(this._getElement()), j.on(this._getElement(), Ki, function () {
          v(_this18._config.clickCallback);
        }), this._isAppended = !0);
      }
    }, {
      key: "dispose",
  ...
  var dn = /*#__PURE__*/function (_B6) {
    _inherits(dn, _B6);

    var _super6 = _createSuper(dn);
    ...
    function dn(e, i) {
      ...
      _this19 = _super6.call(this, e), _this19._config = _this19._getConfig(i), _this19._dialog = t.findOne(".modal-dialog", _this19._element), _this19._backdrop = _this19._initializeBackDrop(), _this19._isShown = !1, _this19._ignoreBackdropClick = !1, _this19._isTransitioning = !1, _this19._scrollBar = new qi();
      return _this19;
    }
    ...
    _createClass(dn, [{
      ...
      value: function show(t) {
        ...
        j.trigger(this._element, en, {
          relatedTarget: t
        }).defaultPrevented || (this._isShown = !0, this._isAnimated() && (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(ln), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), j.on(this._element, on, '[data-coreui-dismiss="modal"]', function (t) {
          return _this20.hide(t);
        }), j.on(this._dialog, an, function () {
          j.one(_this20._element, "mouseup.dismiss.coreui.modal", function (t) {
      ...
      value: function hide(t) {
        ...
        e && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), j.off(document, nn), this._element.classList.remove(cn), j.off(this._element, on), j.off(this._dialog, an), this._queueCallback(function () {
      ...
      value: function dispose() {
        [window, this._dialog].forEach(function (t) {
          return j.off(t, Xi);
        }), this._backdrop.dispose(), _get(_getPrototypeOf(dn.prototype), "dispose", this).call(this), j.off(document, nn);
      }
    }, {
      key: "handleUpdate",
      ...
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, Zi), V.getDataAttributes(this._element)), "object" == _typeof(t) ? t : {}), l(Qi, t, Ji), t;
      }
    }, {
      key: "_showElement",
      value: function _showElement(e) {
        ...
        this._queueCallback(function () {
          _this22._config.focus && _this22._element.focus(), _this22._isTransitioning = !1, j.trigger(_this22._element, "shown.coreui.modal", {
            relatedTarget: e
          });
        }, this._dialog, i);
      }
      ...
      value: function _enforceFocus() {
        ...
        j.off(document, nn), j.on(document, nn, function (t) {
      ...
      value: function _setEscapeEvent() {
        ...
        this._isShown ? j.on(this._element, rn, function (t) {
          _this24._config.keyboard && t.key === Gi ? (t.preventDefault(), _this24.hide()) : _this24._config.keyboard || t.key !== Gi || _this24._triggerBackdropTransition();
      ...
      value: function _setResizeEvent() {
        ...
        this._isShown ? j.on(window, sn, function () {
      ...
      value: function _hideModal() {
        ...
        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(function () {
          document.body.classList.remove(ln), _this26._resetAdjustments(), _this26._scrollBar.reset(), j.trigger(_this26._element, tn);
        });
      }
    }, {
      key: "_showBackdrop",
      value: function _showBackdrop(t) {
        ...
        j.on(this._element, on, function (t) {
      ...
      value: function _triggerBackdropTransition() {
        ...
        !n && "hidden" === i.overflowY || t.contains(hn) || (n || (i.overflowY = "hidden"), t.add(hn), this._queueCallback(function () {
          t.remove(hn), n || _this28._queueCallback(function () {
            i.overflowY = "";
          }, _this28._dialog);
      ...
      value: function jQueryInterface(t, e) {
        return this.each(function () {
          var i = dn.getOrCreateInstance(this, t);
  ...
  j.on(document, "click.coreui.modal.data-api", '[data-coreui-toggle="modal"]', function (t) {
    ...
    var e = s(this);
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(), j.one(e, en, function (t) {
      t.defaultPrevented || j.one(e, tn, function () {
  ...
  var un = "navigation",
    ...
    groupsAutoCollapse: "(string|boolean)"
      ...
      vn = "show",
      bn = "nav-group-toggle",
      yn = "click".concat(pn, ".data-api"),
      wn = "load".concat(pn, ".data-api"),
      En = ".nav-group",
      An = ".nav-group-items",
      Tn = ".nav-group-toggle";

  var Ln = /*#__PURE__*/function (_B7) {
    _inherits(Ln, _B7);

    var _super7 = _createSuper(Ln);
    ...
    function Ln(t, e) {
      ...
      _this30 = _super7.call(this, t), _this30._config = _this30._getConfig(e), _this30._setActiveLink(), _this30._addEventListeners(), H.set(t, fn, _assertThisInitialized(_this30));
      return _this30;
    }
    ...
    _createClass(Ln, [{
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, gn), V.getDataAttributes(this._element)), "object" == _typeof(t) ? t : {}), l(un, t, mn), t;
      }
    }, {
      key: "_setActiveLink",
      value: function _setActiveLink() {
        ...
        Array.from(this._element.querySelectorAll(".nav-link")).forEach(function (t) {
          if (t.classList.contains(bn)) return;
          var e = String(window.location);
          (/\?.*=/.test(e) || /\?./.test(e)) && (e = e.split("?")[0]), /#./.test(e) && (e = e.split("#")[0]), _this31._config.activeLinksExact && t.href === e && (t.classList.add(_n), Array.from(_this31._getParents(t, En)).forEach(function (t) {
            t.classList.add(vn), t.setAttribute("aria-expanded", !0);
          })), !_this31._config.activeLinksExact && t.href.startsWith(e) && (t.classList.add(_n), Array.from(_this31._getParents(t, En)).forEach(function (t) {
            t.classList.add(vn), t.setAttribute("aria-expanded", !0);
          }));
        });
      }
      ...
      key: "_getParents",
      value: function _getParents(t, e) {
        var i = [];
      ...
      key: "_getAllSiblings",
      value: function _getAllSiblings(t, e) {
        var i = [];
      ...
      key: "_getChildren",
      value: function _getChildren(t, e) {
        var i = [];
      ...
      key: "_getSiblings",
      value: function _getSiblings(t, e) {
        return this._getChildren(t.parentNode.firstChild, t).filter(e);
      }
    }, {
      key: "_slideDown",
      value: function _slideDown(t) {
        t.style.height = "auto";
        var e = t.clientHeight;
        t.style.height = "0px", setTimeout(function () {
          t.style.height = "".concat(e, "px");
        }, 0), this._queueCallback(function () {
          t.style.height = "auto";
        }, t, !0);
      }
    }, {
      key: "_slideUp",
      value: function _slideUp(t, e) {
        var i = t.clientHeight;
        t.style.height = "".concat(i, "px"), setTimeout(function () {
          t.style.height = "0px";
        }, 0), this._queueCallback(function () {
          "function" == typeof e && e();
        }, t, !0);
      ...
      key: "_toggleGroupItems",
      value: function _toggleGroupItems(e) {
        var _this32 = this;
        ...
        var n = function n(t) {
          return Boolean(t.classList.contains("nav-group") && t.classList.contains(vn));
        };

        !0 === this._config.groupsAutoCollapse && this._getSiblings(i.parentNode, n).forEach(function (e) {
          _this32._slideUp(t.findOne(An, e), function () {
            e.classList.remove(vn), e.setAttribute("aria-expanded", !1);
          });
        }), i.parentNode.classList.contains(vn) ? this._slideUp(t.findOne(An, i.parentNode), function () {
      ...
      value: function _addEventListeners() {
        ...
        j.on(this._element, yn, Tn, function (t) {
          t.preventDefault(), _this33._toggleGroupItems(t, _this33);
        });
      }
    }], [{
      key: "Default",
      ...
      key: "navigationInterface",
      value: function navigationInterface(t, e) {
        var i = Ln.getOrCreateInstance(t, e);
  ...
  j.on(window, wn, function () {
    Array.from(document.querySelectorAll('[data-coreui="navigation"]')).forEach(function (t) {
      Ln.navigationInterface(t);
    });
  }), _(un);
  var On = "offcanvas",
      Cn = ".coreui.offcanvas",
      kn = "load".concat(Cn, ".data-api"),
      xn = {
    backdrop: !0,
    keyboard: !0,
    scroll: !1
    ...
    scroll: "boolean"
      ...
      Mn = "hide".concat(Cn),
      jn = "hidden".concat(Cn),
      Pn = "focusin".concat(Cn),
      Hn = "click".concat(Cn, ".data-api"),
      Bn = "click.dismiss".concat(Cn),
      Rn = "keydown.dismiss".concat(Cn);

  var Wn = /*#__PURE__*/function (_B8) {
    _inherits(Wn, _B8);

    var _super8 = _createSuper(Wn);
    ...
    function Wn(t, e) {
      ...
      _this34 = _super8.call(this, t), _this34._config = _this34._getConfig(e), _this34._isShown = !1, _this34._backdrop = _this34._initializeBackDrop(), _this34._addEventListeners();
      return _this34;
    }
    ...
    _createClass(Wn, [{
      ...
      value: function hide() {
        ...
        this._queueCallback(function () {
          _this36._element.setAttribute("aria-hidden", !0), _this36._element.removeAttribute("aria-modal"), _this36._element.removeAttribute("role"), _this36._element.style.visibility = "hidden", _this36._config.scroll || new qi().reset(), j.trigger(_this36._element, jn);
        }, this._element, !0);
      }
    }, {
      key: "dispose",
      value: function dispose() {
        this._backdrop.dispose(), _get(_getPrototypeOf(Wn.prototype), "dispose", this).call(this), j.off(document, Pn);
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, xn), V.getDataAttributes(this._element)), "object" == _typeof(t) ? t : {}), l(On, t, Dn), t;
      }
    }, {
      key: "_initializeBackDrop",
      value: function _initializeBackDrop() {
      ...
      value: function _enforceFocusOnElement(t) {
        j.off(document, Pn), j.on(document, Pn, function (e) {
      ...
      value: function _addEventListeners() {
        ...
        j.on(this._element, Bn, '[data-coreui-dismiss="offcanvas"]', function () {
          return _this38.hide();
        }), j.on(this._element, Rn, function (t) {
          _this38._config.keyboard && "Escape" === t.key && _this38.hide();
        });
      }
    }], [{
      key: "NAME",
      ...
      value: function jQueryInterface(t) {
        return this.each(function () {
          var e = Wn.getOrCreateInstance(this, t);
  ...
  j.on(document, Hn, '[data-coreui-toggle="offcanvas"]', function (e) {
    ...
    j.one(i, jn, function () {
      c(_this39) && _this39.focus();
    });
    var n = t.findOne(Sn);
    n && n !== i && Wn.getInstance(n).hide();
    Wn.getOrCreateInstance(i).toggle(this);
  }), j.on(window, kn, function () {
    return t.find(Sn).forEach(function (t) {
      return Wn.getOrCreateInstance(t).show();
    });
  }), _(Wn);

  var qn = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
  ...
  var Yn = "tooltip",
    ...
    popperConfig: null
      ...
      es = {
    HIDE: "hide".concat(Qn),
    HIDDEN: "hidden".concat(Qn),
    SHOW: "show".concat(Qn),
    SHOWN: "shown".concat(Qn),
    INSERTED: "inserted".concat(Qn),
    CLICK: "click".concat(Qn),
    FOCUSIN: "focusin".concat(Qn),
    FOCUSOUT: "focusout".concat(Qn),
    MOUSEENTER: "mouseenter".concat(Qn),
    MOUSELEAVE: "mouseleave".concat(Qn)
  },
      is = "fade",
      ns = "show",
      ss = "show",
  ...
  var ls = /*#__PURE__*/function (_B9) {
    _inherits(ls, _B9);

    var _super9 = _createSuper(ls);
    ...
    function ls(t, e) {
      ...
      _this40 = _super9.call(this, t), _this40._isEnabled = !0, _this40._timeout = 0, _this40._hoverState = "", _this40._activeTrigger = {}, _this40._popper = null, _this40._config = _this40._getConfig(e), _this40.tip = null, _this40._setListeners();
      return _this40;
    }
    ...
    _createClass(ls, [{
      ...
      key: "dispose",
      value: function dispose() {
        clearTimeout(this._timeout), j.off(this._element.closest(".modal"), "hide.coreui.modal", this._hideModalHandler), this.tip && this.tip.remove(), this._popper && this._popper.destroy(), _get(_getPrototypeOf(ls.prototype), "dispose", this).call(this);
      }
    }, {
      key: "show",
      value: function show() {
        ...
        var c = this.tip.classList.contains(is);

        this._queueCallback(function () {
          var t = _this41._hoverState;
          _this41._hoverState = null, j.trigger(_this41._element, _this41.constructor.Event.SHOWN), t === os && _this41._leave(null, _this41);
        }, this.tip, c);
      }
    }, {
      key: "hide",
      value: function hide() {
        ...
        t.classList.remove(ns), "ontouchstart" in document.documentElement && (_ref10 = []).concat.apply(_ref10, _toConsumableArray(document.body.children)).forEach(function (t) {
          return j.off(t, "mouseover", u);
        }), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
        var e = this.tip.classList.contains(is);
        this._queueCallback(function () {
          _this42._isWithActiveTrigger() || (_this42._hoverState !== ss && t.remove(), _this42._cleanTipClass(), _this42._element.removeAttribute("aria-describedby"), j.trigger(_this42._element, _this42.constructor.Event.HIDDEN), _this42._popper && (_this42._popper.destroy(), _this42._popper = null));
      ...
      value: function getTitle() {
        var t = this._element.getAttribute("data-coreui-original-title");
      ...
      value: function _getPopperConfig(t) {
        ...
        var e = {
          ...
          modifiers: [{
            ...
            phase: "afterWrite",
            fn: function fn(t) {
              return _this44._handlePopperPlacementChange(t);
            }
          }],
          onFirstUpdate: function onFirstUpdate(t) {
            t.options.placement !== t.placement && _this44._handlePopperPlacementChange(t);
          }
        };
      ...
      value: function _setListeners() {
        ...
        this._config.trigger.split(" ").forEach(function (t) {
          if ("click" === t) j.on(_this45._element, _this45.constructor.Event.CLICK, _this45._config.selector, function (t) {
            return _this45.toggle(t);
          });else if ("manual" !== t) {
            var _e9 = t === rs ? _this45.constructor.Event.MOUSEENTER : _this45.constructor.Event.FOCUSIN,
                _i12 = t === rs ? _this45.constructor.Event.MOUSELEAVE : _this45.constructor.Event.FOCUSOUT;

            j.on(_this45._element, _e9, _this45._config.selector, function (t) {
              return _this45._enter(t);
            }), j.on(_this45._element, _i12, _this45._config.selector, function (t) {
              return _this45._leave(t);
            });
          }
        }), this._hideModalHandler = function () {
          _this45._element && _this45.hide();
        }, j.on(this._element.closest(".modal"), "hide.coreui.modal", this._hideModalHandler), this._config.selector ? this._config = _objectSpread(_objectSpread({}, this._config), {}, {
          trigger: "manual",
          selector: ""
        }) : this._fixTitle();
      }
      ...
      value: function _fixTitle() {
        var t = this._element.getAttribute("title"),
            e = _typeof(this._element.getAttribute("data-coreui-original-title"));
      ...
      value: function _enter(t, e) {
        e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusin" === t.type ? as : rs] = !0), e.getTipElement().classList.contains(ns) || e._hoverState === ss ? e._hoverState = ss : (clearTimeout(e._timeout), e._hoverState = ss, e._config.delay && e._config.delay.show ? e._timeout = setTimeout(function () {
      ...
      value: function _leave(t, e) {
        e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusout" === t.type ? as : rs] = e._element.contains(t.relatedTarget)), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = os, e._config.delay && e._config.delay.hide ? e._timeout = setTimeout(function () {
      ...
      value: function jQueryInterface(t) {
        return this.each(function () {
          var e = ls.getOrCreateInstance(this, t);
  ...
  var cs = ".coreui.popover",
      hs = new RegExp("(^|\\s)bs-popover\\S+", "g"),
      ds = _objectSpread(_objectSpread({}, ls.Default), {}, {
    placement: "right",
    offset: [0, 8],
    trigger: "click",
    content: "",
    template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
      ...
      us = _objectSpread(_objectSpread({}, ls.DefaultType), {}, {
    content: "(string|element|function)"
  }),
      fs = {
    HIDE: "hide".concat(cs),
    HIDDEN: "hidden".concat(cs),
    SHOW: "show".concat(cs),
    SHOWN: "shown".concat(cs),
    INSERTED: "inserted".concat(cs),
    CLICK: "click".concat(cs),
    FOCUSIN: "focusin".concat(cs),
    FOCUSOUT: "focusout".concat(cs),
    MOUSEENTER: "mouseenter".concat(cs),
    MOUSELEAVE: "mouseleave".concat(cs)
  },
      ps = ".popover-header",
      gs = ".popover-body";

  var ms = /*#__PURE__*/function (_ls) {
    _inherits(ms, _ls);

    var _super10 = _createSuper(ms);
    ...
    _createClass(ms, [{
      ...
      key: "getTipElement",
      value: function getTipElement() {
        return this.tip || (this.tip = _get(_getPrototypeOf(ms.prototype), "getTipElement", this).call(this), this.getTitle() || t.findOne(ps, this.tip).remove(), this._getContent() || t.findOne(gs, this.tip).remove()), this.tip;
      }
    }, {
      key: "setContent",
      value: function setContent() {
      ...
      value: function jQueryInterface(t) {
        return this.each(function () {
          var e = ms.getOrCreateInstance(this, t);
  ...
  var _s = "scrollspy",
    ...
    target: "(string|element)"
      ...
      ws = "activate".concat(vs),
      Es = "scroll".concat(vs),
      As = "load".concat(vs, ".data-api"),
      Ts = "dropdown-item",
      Ls = "active",
      Os = ".nav-link",
  ...
  var xs = /*#__PURE__*/function (_B10) {
    _inherits(xs, _B10);

    var _super11 = _createSuper(xs);
    ...
    function xs(t, e) {
      ...
      _this46 = _super11.call(this, t), _this46._scrollElement = "BODY" === _this46._element.tagName ? window : _this46._element, _this46._config = _this46._getConfig(e), _this46._offsets = [], _this46._targets = [], _this46._activeTarget = null, _this46._scrollHeight = 0, j.on(_this46._scrollElement, Es, function () {
        return _this46._process();
      }), _this46.refresh(), _this46._process();
      return _this46;
    }
    ...
    _createClass(xs, [{
      ...
      value: function refresh() {
        ...
        var e = this._scrollElement === this._scrollElement.window ? "offset" : ks,
            i = "auto" === this._config.method ? e : this._config.method,
            s = i === ks ? this._getScrollTop() : 0;
        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight();
        t.find(Cs, this._config.target).map(function (e) {
          var o = n(e),
          ...
          if (r) {
            ...
            if (_t14.width || _t14.height) return [V[i](r).top + s, o];
          }
          ...
          _this47._offsets.push(t[0]), _this47._targets.push(t[1]);
        });
      }
    }, {
      key: "dispose",
      value: function dispose() {
        j.off(this._scrollElement, vs), _get(_getPrototypeOf(xs.prototype), "dispose", this).call(this);
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
        return (t = _objectSpread(_objectSpread(_objectSpread({}, bs), V.getDataAttributes(this._element)), "object" == _typeof(t) && t ? t : {})).target = a(t.target) || document.documentElement, l(_s, t, ys), t;
      }
    }, {
      key: "_getScrollTop",
      ...
      value: function _activate(e) {
        ...
        var i = Cs.split(",").map(function (t) {
          return "".concat(t, "[data-coreui-target=\"").concat(e, "\"],").concat(t, "[href=\"").concat(e, "\"]");
        }),
            n = t.findOne(i.join(","), this._config.target);
        n.classList.add(Ls), n.classList.contains(Ts) ? t.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Ls) : t.parents(n, ".nav, .list-group").forEach(function (e) {
          t.prev(e, ".nav-link, .list-group-item").forEach(function (t) {
            return t.classList.add(Ls);
          }), t.prev(e, ".nav-item").forEach(function (e) {
            t.children(e, Os).forEach(function (t) {
              return t.classList.add(Ls);
            });
          });
        }), j.trigger(this._scrollElement, ws, {
          relatedTarget: e
        });
      }
    }, {
      ...
      value: function _clear() {
        t.find(Cs, this._config.target).filter(function (t) {
          return t.classList.contains(Ls);
        }).forEach(function (t) {
          return t.classList.remove(Ls);
        });
      }
    }], [{
      key: "Default",
      ...
      value: function jQueryInterface(t) {
        return this.each(function () {
          var e = xs.getOrCreateInstance(this, t);
  ...
  j.on(window, As, function () {
    t.find('[data-coreui-spy="scroll"]').forEach(function (t) {
      return new xs(t);
    });
  }), _(xs);
  var Ds = "sidebar",
      ...
      Rs = "show".concat(Ns),
      Ws = "shown".concat(Ns),
      qs = "click".concat(Ns, ".data-api"),
      Us = "load".concat(Ns, ".data-api"),
      zs = ".sidebar";

  var Vs = /*#__PURE__*/function (_B11) {
    _inherits(Vs, _B11);
    ...
    function Vs(t, e) {
      ...
      _this48 = _super12.call(this, t), _this48._config = _this48._getConfig(e), _this48._show = _this48._isVisible(), _this48._mobile = _this48._isMobile(), _this48._overlaid = _this48._isOverlaid(), _this48._narrow = _this48._isNarrow(), _this48._unfoldable = _this48._isUnfoldable(), _this48._backdrop = null, _this48._addEventListeners();
      return _this48;
    }
    ...
    _createClass(Vs, [{
      ...
      value: function show() {
        ...
        this._queueCallback(function () {
          !0 === _this49._isVisible() && (_this49._show = !0, (_this49._isMobile() || _this49._isOverlaid()) && _this49._addClickOutListener(), j.trigger(_this49._element, Ws));
        }, this._element, !0);
      }
    }, {
      key: "hide",
      value: function hide() {
        ...
        this._queueCallback(function () {
          !1 === _this50._isVisible() && (_this50._show = !1, (_this50._isMobile() || _this50._isOverlaid()) && _this50._removeClickOutListener(), j.trigger(_this50._element, Bs));
        }, this._element, !0);
      }
    }, {
      key: "toggle",
      ...
      key: "toggleNarrow",
      value: function toggleNarrow() {
        this._narrow ? this.reset() : this.narrow();
      }
    }, {
      key: "toggleUnfoldable",
      value: function toggleUnfoldable() {
        this._unfoldable ? this.reset() : this.unfoldable();
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, Ss), V.getDataAttributes(this._element)), "object" == _typeof(t) ? t : {}), l(Ds, t, Is), t;
      }
    }, {
      key: "_isMobile",
      ...
      key: "_addClassName",
      value: function _addClassName(t) {
      ...
      value: function _clickOutListener(t, e) {
      ...
      value: function _addClickOutListener() {
        ...
        j.on(document, qs, function (t) {
          _this51._clickOutListener(t, _this51);
        });
      }
    }, {
      ...
      value: function _addEventListeners() {
        ...
        this._mobile && this._show && this._addClickOutListener(), this._overlaid && this._show && this._addClickOutListener(), j.on(this._element, qs, "[data-coreui-toggle]", function (t) {
          t.preventDefault();
          var e = V.getDataAttribute(t.target, "toggle");
          "narrow" === e && _this52.toggleNarrow(), "unfoldable" === e && _this52.toggleUnfoldable();
        }), j.on(this._element, qs, '[data-coreui-close="sidebar"]', function (t) {
          t.preventDefault(), _this52.hide();
        }), j.on(window, "resize", function () {
          _this52._isMobile() && _this52._isVisible() && _this52.hide();
        });
      }
    }], [{
      key: "Default",
      ...
      key: "sidebarInterface",
      value: function sidebarInterface(t, e) {
        var i = Vs.getOrCreateInstance(t, e);
  ...
  j.on(window, Us, function () {
    Array.from(document.querySelectorAll(zs)).forEach(function (t) {
  ...
  var Gs = /*#__PURE__*/function (_B12) {
    _inherits(Gs, _B12);

    var _super13 = _createSuper(Gs);
    ...
    _createClass(Gs, [{
      ...
      value: function show() {
        ...
        if (n) {
          var _i13 = "UL" === n.nodeName || "OL" === n.nodeName ? Xs : Qs;

          e = t.find(_i13, n), e = e[e.length - 1];
        }

        var o = e ? j.trigger(e, "hide.coreui.tab", {
          relatedTarget: this._element
        }) : null;
        if (j.trigger(this._element, "show.coreui.tab", {
          relatedTarget: e
        ...
        var r = function r() {
          j.trigger(e, "hidden.coreui.tab", {
            relatedTarget: _this53._element
          }), j.trigger(_this53._element, "shown.coreui.tab", {
            relatedTarget: e
          });
        };
      ...
      value: function _activate(e, i, n) {
        ...
        var s = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? t.children(i, Qs) : t.find(Xs, i))[0],
            o = n && s && s.classList.contains(Ks),
            r = function r() {
          return _this54._transitionComplete(e, s, n);
        };
      ...
      value: function _transitionComplete(e, i, n) {
        if (i) {
          ...
          _e12 && _e12.classList.remove(Fs), "tab" === i.getAttribute("role") && i.setAttribute("aria-selected", !1);
        }
  ...
  var Zs = "toast",
      Js = ".coreui.toast",
      to = "click.dismiss".concat(Js),
      eo = "mouseover".concat(Js),
      io = "mouseout".concat(Js),
      no = "focusin".concat(Js),
      so = "focusout".concat(Js),
      oo = "hide".concat(Js),
      ro = "hidden".concat(Js),
      ao = "show".concat(Js),
      lo = "shown".concat(Js),
  ...
  var go = /*#__PURE__*/function (_B13) {
    _inherits(go, _B13);

    var _super14 = _createSuper(go);
    ...
    function go(t, e) {
      ...
      _this55 = _super14.call(this, t), _this55._config = _this55._getConfig(e), _this55._timeout = null, _this55._hasMouseInteraction = !1, _this55._hasKeyboardInteraction = !1, _this55._setListeners();
      return _this55;
    }
    ...
    _createClass(go, [{
      ...
      value: function show() {
        ...
        this._element.classList.remove(co), f(this._element), this._element.classList.add(uo), this._queueCallback(function () {
          _this56._element.classList.remove(uo), _this56._element.classList.add(ho), j.trigger(_this56._element, lo), _this56._maybeScheduleHide();
      ...
      value: function hide() {
        ...
        this._element.classList.remove(ho), this._queueCallback(function () {
          _this57._element.classList.add(co), j.trigger(_this57._element, ro);
        }, this._element, this._config.animation);
      }
    }, {
      key: "dispose",
      value: function dispose() {
        this._clearTimeout(), this._element.classList.contains(ho) && this._element.classList.remove(ho), _get(_getPrototypeOf(go.prototype), "dispose", this).call(this);
      }
    }, {
      key: "_getConfig",
      value: function _getConfig(t) {
        return t = _objectSpread(_objectSpread(_objectSpread({}, po), V.getDataAttributes(this._element)), "object" == _typeof(t) && t ? t : {}), l(Zs, t, this.constructor.DefaultType), t;
      }
    }, {
      ...
      value: function _setListeners() {
        ...
        j.on(this._element, to, '[data-coreui-dismiss="toast"]', function () {
          return _this59.hide();
        }), j.on(this._element, eo, function (t) {
          return _this59._onInteraction(t, !0);
        }), j.on(this._element, io, function (t) {
          return _this59._onInteraction(t, !1);
        }), j.on(this._element, no, function (t) {
          return _this59._onInteraction(t, !0);
        }), j.on(this._element, so, function (t) {
          return _this59._onInteraction(t, !1);
        });
      }
    }, {
      ...
      value: function jQueryInterface(t) {
        return this.each(function () {
          var e = go.getOrCreateInstance(this, t);
...
/***/ "./resources/js/dashboard/simplebar.min.js":
/*!*************************************************!*\
  !*** ./resources/js/dashboard/simplebar.min.js ***!
  \*************************************************/
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! ./simplebar.min */ "./resources/js/dashboard/simplebar.min.js");

__webpack_require__(/*! ./coreui.bundle.min */ "./resources/js/dashboard/coreui.bundle.min.js");
})();
